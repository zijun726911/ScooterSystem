...
public class RentPanel extends JPanel{
	public RentPanel() {
		...
		JLabel labelSecond = new JLabel("60");
		GUIUtil.getInstance().countDown(labelSecond, 60);
		labelSecond.setFont(new Font("Î¢ÈíÑÅºÚ", Font.BOLD, 20));
		labelSecond.setBounds(769, 15, 43, 49);
